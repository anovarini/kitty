...
import org.apache.kitty.listener.LsListener

final class Ls implements Command {

    String commandName = 'ls'
    String commandArguments = ''
    String commandDescription = 'Prints the content of the current location'

    @groovy.beans.ListenerList
    List<LsListener> listeners
